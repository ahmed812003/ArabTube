...
namespace ArabTube.Services.ControllersServices.PlaylistVideoServices.Interfaces
{
    ...
    {
        Task<ProcessResult> AddVideoToPlayListAsync(string videoId, string playlistId);
        ...
        Task<ProcessResult> RemoveVideoFromPlaylistAsync(string videoId, string playlistId);
    }
}
